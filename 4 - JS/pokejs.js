    ...
    function setNameDescriptionTypes(){
        ...
        .then((data) => {
            ...
            if(language === 'en'){
                ...
                let arr = []
                movs.forEach(movs => {
                    arr.push(movs.move.name)
                });

                document.getElementById("screen-description").innerHTML= "Movements: " + arr[0] + ", " + arr[1] + ", " + arr[2] + ", " + arr[3];
            }
            if(language === 'es'){
                let movs = data.moves;
                let arr = []
                ...
                document.getElementById("screen-description").innerHTML= "Movimientos: " + arr[0] + ", " + arr[1] + ", " + arr[2] + ", " + arr[3];
            }
